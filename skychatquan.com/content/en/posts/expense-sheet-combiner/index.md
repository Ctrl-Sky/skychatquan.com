...
This is a personal expense tracker automation tool. This is something I created to help keep track of my expenses across multiple cards. It takes into account the activity of each card as a csv format, standardizes all of them to fit my specific format, and then combines them all into one master excel file. Filtering each purchase into a new sheet respective to the month the expense was made in.
